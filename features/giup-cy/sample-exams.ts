...
const hungYenQuestions: SampleQuestion[] = [
  ...
  { section: "Phần I", question_number: 12, question_type: "single_choice", prompt: "Cho biết: E0(Fe2+/Fe) = -0,440V; E0(Cu2+/Cu) = +0,340V. Sức điện động chuẩn của pin điện hoá Fe - Cu là", options: choice("0,780 V", "0,920 V", "0,100 V", "1,660 V"), correct_answer: "A", points: 0.25, sort_order: 12 },
