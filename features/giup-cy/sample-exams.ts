...
const hungYenQuestions: SampleQuestion[] = [
  { section: "Phần I", question_number: 1, question_type: "single_choice", prompt: "Carbohydrate là những hợp chất hữu cơ tạp chức hầu hết có công thức chung là", options: choice("R(OH)x(CHO)y", "C2H2O2", "Cn(H2O)m", "CnH2O"), correct_answer: null, points: 0.25, needs_review: true, sort_order: 1 },
  { section: "Phần I", question_number: 2, question_type: "single_choice", prompt: "Có bao nhiêu dipeptide mạch hở khi thủy phân hoàn toàn thu được hỗn hợp chỉ gồm glycine và alanine?", options: choice("4", "2", "3", "1"), correct_answer: null, points: 0.25, sort_order: 2 },
  { section: "Phần I", question_number: 3, question_type: "single_choice", prompt: "Chất nào sau đây là amine bậc một?", options: choice("C6H5NH2", "(CH3)3N", "CH3NHC2H5", "(CH3)2NH"), correct_answer: null, points: 0.25, sort_order: 3 },
  { section: "Phần I", question_number: 4, question_type: "single_choice", prompt: "Giá trị thế điện cực chuẩn của cặp oxi hoá - khử nào được quy ước bằng 0 V?", options: choice("Na+/Na", "Cu2+/Cu", "2H+/H2", "Al3+/Al"), correct_answer: null, points: 0.25, sort_order: 4 },
  { section: "Phần I", question_number: 5, question_type: "single_choice", prompt: "Cho một số tính chất: có dạng sợi (1); tan trong nước (2); tan trong nước Schweizer (3); phản ứng với nitric acid đặc (xúc tác sulfuric acid đặc) (4); tham gia phản ứng với thuốc thử Tollens (5); bị thủy phân trong dung dịch acid đun nóng (6). Các tính chất của cellulose là", options: choice("(1), (3), (4) và (6)", "(3), (4), (5) và (6)", "(1), (2), (3) và (4)", "(2), (3), (4) và (5)"), correct_answer: null, points: 0.25, sort_order: 5 },
  { section: "Phần I", question_number: 6, question_type: "single_choice", prompt: "Cho các chất sau: saccharose, glycine, acetic acid, ethyl formate, aniline. Số chất tác dụng với dung dịch NaOH trong điều kiện thích hợp là", options: choice("3", "2", "4", "1"), correct_answer: null, points: 0.25, sort_order: 6 },
  { section: "Phần I", question_number: 7, question_type: "single_choice", prompt: "Tơ nào sau đây thuộc loại tơ thiên nhiên?", options: choice("Tơ nitron (hay olon)", "Tơ visco", "Tơ tằm", "Tơ nylon-6,6"), correct_answer: null, points: 0.25, sort_order: 7 },
  { section: "Phần I", question_number: 8, question_type: "single_choice", prompt: "Kí hiệu cặp oxi hoá - khử ứng với quá trình khử: Fe3+ + 1e ⇌ Fe2+ là", options: choice("Fe2+/Fe3+", "Fe3+/Fe", "Fe3+/Fe2+", "Fe2+/Fe"), correct_answer: null, points: 0.25, sort_order: 8 },
  { section: "Phần I", question_number: 9, question_type: "single_choice", prompt: "Thủy phân ester X trong dung dịch acid, thu được sản phẩm gồm CH3COOH và CH3OH. Công thức cấu tạo của X là", options: choice("CH3COOC2H5", "CH3COOCH3", "HCOOC2H5", "C2H5COOCH3"), correct_answer: null, points: 0.25, sort_order: 9 },
  { section: "Phần I", question_number: 10, question_type: "single_choice", prompt: "Hợp chất nào dưới đây thuộc loại ester?", options: choice("CH3CH2CH2COOH", "CH3CH2COOCH3", "CH3CH2OH", "CH3CH2CHO"), correct_answer: null, points: 0.25, sort_order: 10 },
  { section: "Phần I", question_number: 11, question_type: "single_choice", prompt: "Hợp chất H2NCH2COOH có tên gọi thông thường là", options: choice("glycine", "lysine", "valine", "alanine"), correct_answer: null, points: 0.25, sort_order: 11 },
  { section: "Phần I", question_number: 12, question_type: "single_choice", prompt: "Cho biết: E0(Fe2+/Fe) = -0,440V; E0(Cu2+/Cu) = +0,340V. Sức điện động chuẩn của pin điện hoá Fe - Cu là", options: choice("0,780 V", "0,920 V", "0,100 V", "1,660 V"), correct_answer: null, points: 0.25, sort_order: 12 },
  { section: "Phần I", question_number: 13, question_type: "single_choice", prompt: "Phát biểu nào sau đây là không đúng?", options: choice("Amylopectin (có trong tinh bột) có cấu trúc mạch phân nhánh.", "Tơ nitron (hay olon) thường được dùng để dệt vải may quần áo ấm hoặc bện thành sợi \"len\" đan áo rét.", "Tơ nylon-6 được điều chế bằng phản ứng trùng ngưng omega-aminocaproic acid.", "Cao su buna-N có tính đàn hồi tốt hơn và bền với dầu mỡ hơn cao su buna thường."), correct_answer: null, points: 0.25, sort_order: 13 },
  { section: "Phần I", question_number: 14, question_type: "single_choice", prompt: "Khi nghiên cứu về carbohydrate X, nhận thấy:\n- X thủy phân hoàn toàn trong dung dịch acid thu được hai sản phẩm hữu cơ.\n- X không có phản ứng với thuốc thử Tollens.\nVậy X có thể là", options: choice("fructose", "cellulose", "saccharose", "tinh bột"), correct_answer: null, points: 0.25, sort_order: 14 },
  { section: "Phần I", question_number: 15, question_type: "single_choice", prompt: "Glucose là một loại monosaccharide có nhiều trong quả nho chín. Công thức phân tử của glucose là", options: choice("(C6H10O5)n", "C2H4O2", "C6H12O6", "C12H22O11"), correct_answer: null, points: 0.25, sort_order: 15 },
  ...
  { section: "Phần III", question_number: 28, question_type: "short_answer", prompt: "Dung dịch saccharose không phản ứng với thuốc thử Tollens, nhưng khi đun nóng với dung dịch acid loãng thì tạo thành dung dịch phản ứng với thuốc thử Tollens. Thủy phân hoàn toàn 0,5 mol saccharose thu được dung dịch X. X tác dụng hoàn toàn với dung dịch AgNO3/NH3 dư thu được a mol Ag. Giá trị của a là bao nhiêu?", options: [], correct_answer: null, points: 0.5, sort_order: 28 }
];
